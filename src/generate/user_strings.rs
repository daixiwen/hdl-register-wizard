...
pub const USER_NAMES_SPECS: [UserStringSpec; 29] = [
    UserStringSpec {
        ...
        description: "Name of the top entity, instanciating the core and the PIFs",
    },
    UserStringSpec {
        template_name: GM_CORE_NAME,
        label: "Core",
        default_value: "{{ project }}*_core",
        description: "Name of the core entity, containing user code",
    },
    UserStringSpec {
        template_name: GM_CORE_INSTANCE,
        label: "Core instance",
        default_value: "i_{{ project }}*_core_0",
        description: "Name of the core instance in the top entity",
    },
    UserStringSpec {
        template_name: GM_PKG_NAME,
        label: "Package",
        default_value: "{{ project }}*_pkg",
        description: "Name of the package containing all the definitions",
    },
    UserStringSpec {
        template_name: GI_PIF_NAME,
        label: "Pif",
        default_value: "{{ project }}_{{ interface }}*_pif",
        description:
            "Name of the pif (processor interface) entity, containing the interface generated code",
    },
    UserStringSpec {
        template_name: GI_PIF_INSTANCE,
        label: "Pif instance",
        default_value: "i_{{ project }}_{{ interface }}*_pif_0",
        description: "Name of the pif instance in the top entity",
    },
    UserStringSpec {
        template_name: GI_CORE2PIF_NAME,
        label: "Core to pif",
        default_value: "{{ interface }}*_core2pif",
        description: "Name of the record containing the signals from the core to the pif",
    },
    UserStringSpec {
        template_name: GI_PIF2CORE_NAME,
        label: "Pif to core",
    ...
    UserStringSpec {
        ...
        label: "Register enum",
        default_value: "t_{{ interface }}*_regs",
        description: "Name of the type enumerating all the registers",
    },
    UserStringSpec {
        template_name: GI_ADDRESS_DECODER_NAME,
        label: "Address decoder",
        default_value: "f_{{ interface }}*_address_decode",
    ...
    UserStringSpec {
        template_name: GI_ADDRESS_WIDTH_CONST_NAME,
        label: "Address width",
        default_value: "c_{{ interface }}*_address_width",
        description: "Name of the constant containing the size of the address bus",
    },
    UserStringSpec {
        template_name: GI_DATA_WIDTH_CONST_NAME,
        label: "Data width",
        default_value: "c_{{ interface }}*_data_width",
        description: "Name of the constant containing the size of the data bus",
    },
    UserStringSpec {
        template_name: GR_ADDRESS_CONST_NAME,
        label: "Register address",
        default_value: "c_{{ project }}_{{ interface }}_{{ register }}*_addr",
        description: "Name of the constant containing the register address",
    },
    UserStringSpec {
        template_name: GR_STRIDE_COUNT_CONST_NAME,
        label: "Stride count",
        default_value: "c_{{ project }}_{{ interface }}_{{ register }}*_count",
        description: "Name of the constant containing the register stride number",
    },
    UserStringSpec {
        template_name: GR_STRIDE_OFFSET_CONST_NAME,
        label: "Stride offset",
        default_value: "c_{{ project }}_{{ interface }}_{{ register }}*_offset",
        description: "Name of the constant containing the register stride offset",
    },
    UserStringSpec {
    ...
    UserStringSpec {
        template_name: GR_WIDTH_CONST_NAME,
        label: "Register width",
        default_value: "c_{{ project }}_{{ interface }}_{{ register }}*_width",
        description: "Name of the constant contining the register width",
    },
    UserStringSpec {
        template_name: GR_DATA_NAME,
        label: "Register name",
        default_value: "{{ register }}*",
        description: "Name of the register in the core2pif and pif2core records",
    },
    UserStringSpec {
        template_name: GR_READ_ENABLE_NAME,
        label: "Register read enable",
        default_value: "{{ register }}_re*",
        description: "Name of the register read enable signal in the pif2core record",
    },
    UserStringSpec {
        template_name: GR_WRITE_ENABLE_NAME,
        label: "Register write enable",
        default_value: "{{ register }}_we*",
        description: "Name of the register write enable signal in the pif2core record",
    },
    UserStringSpec {
        template_name: GF_WIDTH_CONST_NAME,
        label: "Field width",
        default_value: "c_{{ project }}_{{ interface }}_{{ register }}_{{ field }}*_width",
        description: "Name of the constant containing the field width",
    },
    UserStringSpec {
        template_name: GF_OFFSET_CONST_NAME,
        label: "Field offset",
        default_value: "c_{{ project }}_{{ interface }}_{{ register }}_{{ field }}*_offset",
        description: "Name of the constant containing the field offset",
    },
    UserStringSpec {
        template_name: GF_DATA_NAME,
        label: "Field name",
        default_value: "{{ field }}*",
    ...
    UserStringSpec {
        ...
        label: "Field read enable",
        default_value: "{{ field }}_re*",
        description: "Name of the field read enable signal",
    },
    UserStringSpec {
        template_name: GF_WRITE_ENABLE_NAME,
        label: "Field write enable",
        default_value: "{{ field }}_we*",
        description: "Name of the field write enable signal",
    },
];

pub const USER_COMMENTS_SPECS: [UserStringSpec; 6] = [
    UserStringSpec {
        template_name: GR_DATA_DESCRIPTION,
        label: "Register description",
        default_value: "data for {{ full_name }}",
        description: "Description for register",
    },
    UserStringSpec {
        template_name: GR_READ_ENABLE_DESCRIPTION,
        label: "Register read enable",
        default_value: "signals that {{ full_name }} is being read",
        description: "Description for the register read enable signal",
    },
    UserStringSpec {
        template_name: GR_WRITE_ENABLE_DESCRIPTION,
        label: "Register write enable",
        default_value: "signals that {{ full_name }} is being written",
        description: "Description for the write enable signal",
    },
    UserStringSpec {
        template_name: GF_DATA_DESCRIPTION,
        label: "Field description",
        default_value: "data for {{ full_name }}",
        description: "Description for field",
    },
    UserStringSpec {
        template_name: GF_READ_ENABLE_DESCRIPTION,
        label: "Field read enable",
        default_value: "signals that {{ full_name }} is being read",
        description: "Description for the field read enable signal",
    },
    UserStringSpec {
        template_name: GF_WRITE_ENABLE_DESCRIPTION,
        label: "Field write enable",
        default_value: "signals that {{ full_name }} is being written",
        description: "Description for the field write enable signal",
    },
];

fn load_defaults_from_iter(
    templates_list: &mut BTreeMap<String, String>,
    iter: Iter<'_, UserStringSpec>,
) {
    for spec in iter {
...
pub fn update_engine(engine: &mut Tera, settings: &Settings) -> Result<(), String> {
    engine
        .add_raw_templates(settings.user_templates.clone())
        .map_err(|error| {
            format!(
                "Error while parsing user string templates from settings: {}",
                error.to_string()
            )
        })
}
