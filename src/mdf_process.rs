                ...
                match self.get_data_width() {
                    ...
                    Some(interface_width) => {
                        ...
                        let high_address =
                            self.registers
                                .iter()
                                .fold(Some(0 as u128), |high_address, reg| match high_address {
                                    None => None,
                                    Some(current_max) => match reg.high_address(interface_width) {
                                        None => None,
                                        Some(address) => Some(u128::max(current_max, address)),
                                    },
                                });
